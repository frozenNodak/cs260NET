...
<body style="height: 212px; background-color: cadetblue; text-align: center">
    ...
    <form id="form1" runat="server" style="text-align:center; background-color:cadetblue" font-size="X-Large">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Desktop %>" ProviderName="<%$ ConnectionStrings:Desktop.ProviderName %>" SelectCommand="SELECT [Name], [AID] FROM [Authors]"></asp:SqlDataSource>
        <br />
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Desktop %>" ProviderName="<%$ ConnectionStrings:Desktop.ProviderName %>" SelectCommand="SELECT [Name], [PID] FROM [Publishers]"></asp:SqlDataSource>
        <br />
